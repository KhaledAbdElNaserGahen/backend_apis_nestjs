...
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(['sign_language', 'medical', 'educational', 'emergency', 'general']),
    __metadata("design:type", String)
], UpdateVideoDto.prototype, "category", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(['processing', 'active', 'inactive']),
    __metadata("design:type", String)
